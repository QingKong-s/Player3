...
void CWndMain::PageShow(Page ePage, BOOL bAnimate)
{
...
void CWndMain::PageClearAnimation()
{
    if (!m_pAnPage)
        return;
    m_pecPage->End();
...
void CWndMain::TlTick(int iMs)
{
    ...
    EckCounter(4, i)
    {
        ...
        eck::CalcPointFromLineScalePos(ptMini[i].x, ptMini[i].y,
